...
function About() {
  return (
    <div className="w-full">
      ...
      >
        <div className="z-50 pb-20 h-full flex flex-col justify-center">
          <div className="xl:px-12 2xl:px-24 pt-12 flex flex-col items-start justify-center mx-auto">
            <div className="w-full lg:w-7/12 pt-20 mb-4 px-10 xl:px-8 2xl:px-6">
              ...
              <p className="text-sm md:text-md py-4">
                ...
                role, I’ve used frameworks like React and Angular to build and maintain clean, high-performing
                user interfaces for data-heavy platforms.
              </p>
              <p className="text-sm md:text-md py-4">
