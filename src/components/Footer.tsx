...
function Footer() {
  return (
    <div>
      <div className="py-24 bg-black text-white w-full">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex-col w-2/5 font-light">
            ...
            <div className="flex w-5/6 justify-between py-16">
              <ul>
                <Link to="/about">
              ...
              <ul>
                ...
                <li className="py-2">laianavalon@gmail.com</li>
                <li className="py-2">PHONE | WHATSAPP</li>
                <li className="py-2">+34 620 182 796</li>
              </ul>
            </div>
      ...
      <div className="bg-white flex justify-center py-4 text-xs">
