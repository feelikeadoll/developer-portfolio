...
function Navbar(props: NavbarProps) {
  return (
    <div className={`text-black ${props.displayNavbar}`}>
      ...
      <div className="hidden md:block w-full h-20 md:h-32 left-0 py-4 bg-lightgrey absolute z-50 px-10 xl:px-8 2xl:px-6">
        <div className="xl:px-12 2xl:px-24 mx-auto flex justify-between items-start md:items-center">
          <div className="flex items-center w-full 2xl:w-1/2 text-black">
            <NavLink
              onClick={props.closeNavbar}
              to="/"
              className="text-lg font-bold flex items-center"
