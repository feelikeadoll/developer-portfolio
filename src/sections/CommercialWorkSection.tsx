...
function CommercialWorkSection() {
    return <section
        id="commercial"
        className="w-full px-10 xl:px-8 2xl:px-6 bg-midgrey text-black h-full lg:h-screen flex flex-col justify-between"
    >
        <div className="w-full h-full xl:px-12 2xl:px-24 mx-auto flex flex-col items-start justify-between">
